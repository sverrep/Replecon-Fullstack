...
def createPolicies():
    policies = [
        vakt.Policy(
            ...
            actions=[Eq('GET')],
            resources=[Eq('classroom'), Eq('bank'), Eq('store'), Eq('tax'), Eq('userid'), Eq('item'), Eq('boughtitem'), Eq('students')],
            subjects=[Eq('Teacher')],
        ...
        vakt.Policy(
            ...
            actions=[Eq('DELETE')],
            resources=[Eq('classroom'), Eq('bank'), Eq('store'), Eq('tax'), Eq('userid'), Eq('item')],
            subjects=[Eq('Teacher')],
            effect=vakt.ALLOW_ACCESS,
        ),
        vakt.Policy(
            ...
            actions=[Eq('GET')],
            resources=[Eq('classroom'), Eq('store'), Eq('item'), Eq('boughtitem'), Eq('studentclasscode'), Eq('teacherlist'), Eq('currentstudent'), Eq('storeuser'), Eq('bankuser'), Eq('balance')],
            subjects=[Eq('Student')],
            effect=vakt.ALLOW_ACCESS,
        ),
        vakt.Policy(
