...
class TeacherUpdateRegScreen extends Component {
...
deleteBracket(){
    axios.delete(getIP()+'/regressivebrackets/'+ this.state.arOfId[this.state.progAmount-1])
        .then(response => {
...
export default function(props) {
    ...
    return <TeacherUpdateRegScreen {...props} navigation={navigation} />;
}