...
class LoginOrSignupForm extends Component {
    ...
    onEmailChange(text) {
        this.setState({ email: text, showError: false });
    }

    onPasswordChange(text) {
        this.setState({ password: text, showError: false });
    }

    onFirstNameChange(text) {
        this.setState({ first_name: text, showError: false });
    }

    onClassCodeChange(text) {
        this.setState({ class_code: text, showError: false });
    }

    onLastNameChange(text) {
        this.setState({ last_name: text, showError: false });
    }
    ...
    handleRequest() {
        if(this.ValidateData())
        {
            ...
            .catch(error => this.setState({error: "No user found with credentials", showError: true}));
        }
